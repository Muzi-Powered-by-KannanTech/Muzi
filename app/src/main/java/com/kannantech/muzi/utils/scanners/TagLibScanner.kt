...
import com.kannantech.muzi.constants.DEBUG_SAVE_OUTPUT
import com.kannantech.muzi.constants.EXTRACTOR_DEBUG
...
import com.kannantech.muzi.ui.utils.EXTRACTOR_TAG
...
class TagLibScanner : MetadataScanner {
    ...
    override suspend fun getAllMetadataFromFile(file: File): SongTempData {
        ...
        ParcelFileDescriptor.open(file, ParcelFileDescriptor.MODE_READ_ONLY).use { fd ->
            ...
            codec = file.extension.uppercase()
