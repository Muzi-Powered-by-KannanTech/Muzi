...
import com.kannantech.muzi.utils.YTPlayerUtils.MAIN_CLIENT
import com.kannantech.muzi.utils.YTPlayerUtils.STREAM_FALLBACK_CLIENTS
import com.kannantech.muzi.utils.YTPlayerUtils.validateStatus
import com.kannantech.muzi.utils.potoken.PoTokenGenerator
import com.kannantech.muzi.utils.potoken.PoTokenResult
import com.kannantech.innertube.NewPipeUtils
import com.kannantech.innertube.YouTube
import com.kannantech.innertube.models.YouTubeClient
import com.kannantech.innertube.models.YouTubeClient.Companion.ANDROID_VR_NO_AUTH
...
object YTPlayerUtils {
     ...
     *
     * [com.kannantech.innertube.models.YouTubeClient.ANDROID_VR_NO_AUTH] Is temporally used as it is out only working client
     * [com.kannantech.innertube.models.YouTubeClient.WEB_REMIX] should be preferred here because currently it is the only client which provides:
