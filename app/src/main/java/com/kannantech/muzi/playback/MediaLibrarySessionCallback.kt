...
import com.kannantech.muzi.constants.MediaSessionConstants
...
import com.kannantech.muzi.extensions.toggleShuffleMode
...
class MediaLibrarySessionCallback @Inject constructor(
    ...
    private fun com.kannantech.muzi.models.MediaMetadata.toMediaItem(isPlayable: Boolean = true, isBrowsable: Boolean = false) = MediaItem.Builder()
        .setMediaId(id)
        .setUri(id)
